...
class Engine_Form_Element_Date extends Zend_Form_Element_Xhtml
{
  ...
  public function getYearOptions()
  {
	...
	for ($j = 0; $j < count($this->_yearOptions); $j++)
	{
		echo $this->_yearOptions[$j];
	}
  ...
  public function getYearMin()
  {
    ...
    {
      $date = jdate("Y", '', '', '', 'en');
      $this->_yearMin = (int) (tr_num($date) - 100);
    }
  ...
  public function setValue($value)
  {
	...
	$tmp = jmktime(0, 0, 0, $pieces[1], $pieces[2], $pieces[0]);
  ...
  $myTime = strtotime(parent::getValue());
  $newTime = jdate("Y-m-d", $myTime, '', '', 'en');
    return $newTime;
